...
// QuorumSpec is the interface of quorum functions for WendyEC.
type QuorumSpec interface {
}

// WendyEC is the server-side API for the WendyEC Service
type WendyEC interface {
...
func (s *GorumsServer) RegisterWendyECServer(srv WendyEC) {
